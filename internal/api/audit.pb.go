...
type AuditRecordDetail struct {
	...
	// 审核前内容快照（结构化）
	OldContentObj *structpb.Struct `protobuf:"bytes,12,opt,name=oldContentObj,proto3" json:"oldContentObj"`
	// 审核后内容快照（结构化）
	NewContentObj *structpb.Struct `protobuf:"bytes,13,opt,name=newContentObj,proto3" json:"newContentObj"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AuditRecordDetail) GetOldContentObj() *structpb.Struct {
	if x != nil {
		return x.OldContentObj
	}
	return nil
}

func (x *AuditRecordDetail) GetNewContentObj() *structpb.Struct {
	if x != nil {
		return x.NewContentObj
	}
	return nil
}
...
const file_internal_api_audit_proto_rawDesc = "" +
	"\n" +
	"\x18internal/api/audit.proto\x12\x05audit\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\x1a\x1cgoogle/protobuf/struct.proto\"\xf9\x01\n" +
	...
	"\x06record\x18\x01 \x01(\v2\x18.audit.AuditRecordDetailR\x06record\"\xd5\x03\n" +
	...
	"\roldContentObj\x18\f \x01(\v2\x17.google.protobuf.StructR\roldContentObj\x12=\n" +
	"\rnewContentObj\x18\r \x01(\v2\x17.google.protobuf.StructR\rnewContentObj2\xee\x04\n" +
	"\fAuditService\x12s\n" +
...
var file_internal_api_audit_proto_depIdxs = []int32{
	...
	12, // 2: audit.AuditRecordDetail.oldContentObj:type_name -> google.protobuf.Struct
	12, // 3: audit.AuditRecordDetail.newContentObj:type_name -> google.protobuf.Struct
	0,  // 4: audit.AuditService.PendingAuditList:input_type -> audit.PendingAuditListRequest
	3,  // 5: audit.AuditService.AuditApproval:input_type -> audit.AuditApprovalRequest
	5,  // 6: audit.AuditService.AuditRejection:input_type -> audit.AuditRejectionRequest
	7,  // 7: audit.AuditService.AuditBatchDecision:input_type -> audit.AuditBatchDecisionRequest
	9,  // 8: audit.AuditService.AuditRecordDetail:input_type -> audit.AuditRecordDetailRequest
	1,  // 9: audit.AuditService.PendingAuditList:output_type -> audit.PendingAuditListResponse
	4,  // 10: audit.AuditService.AuditApproval:output_type -> audit.AuditApprovalResponse
	6,  // 11: audit.AuditService.AuditRejection:output_type -> audit.AuditRejectionResponse
	8,  // 12: audit.AuditService.AuditBatchDecision:output_type -> audit.AuditBatchDecisionResponse
	10, // 13: audit.AuditService.AuditRecordDetail:output_type -> audit.AuditRecordDetailResponse
