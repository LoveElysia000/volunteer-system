...
type AuditRecordDetail struct {
	...
	// 审核前状态
	OldStatus int32 `protobuf:"varint,5,opt,name=oldStatus,proto3" json:"oldStatus"`
	// 审核后状态
	NewStatus int32 `protobuf:"varint,6,opt,name=newStatus,proto3" json:"newStatus"`
	// 审核前内容快照
	OldContent string `protobuf:"bytes,7,opt,name=oldContent,proto3" json:"oldContent"`
	// 审核后内容快照
	NewContent string `protobuf:"bytes,8,opt,name=newContent,proto3" json:"newContent"`
	// 审核结果
	AuditResult int32 `protobuf:"varint,9,opt,name=auditResult,proto3" json:"auditResult"`
	// 驳回原因
	RejectReason string `protobuf:"bytes,10,opt,name=rejectReason,proto3" json:"rejectReason"`
	// 审核时间
	AuditTime string `protobuf:"bytes,11,opt,name=auditTime,proto3" json:"auditTime"`
	// 记录创建时间
...
func (x *AuditRecordDetail) GetOldStatus() int32 {
	if x != nil {
		return x.OldStatus
	}
	return 0
...
func (x *AuditRecordDetail) GetNewStatus() int32 {
	if x != nil {
		return x.NewStatus
	}
	return 0
...
const file_internal_api_audit_proto_rawDesc = "" +
	...
	"\x06record\x18\x01 \x01(\v2\x18.audit.AuditRecordDetailR\x06record\"\xfb\x02\n" +
	...
	"\tauditorId\x18\x04 \x01(\x03R\tauditorId\x12\x1c\n" +
	"\toldStatus\x18\x05 \x01(\x05R\toldStatus\x12\x1c\n" +
	"\tnewStatus\x18\x06 \x01(\x05R\tnewStatus\x12\x1e\n" +
	"\n" +
	"oldContent\x18\a \x01(\tR\n" +
	"oldContent\x12\x1e\n" +
	"\n" +
	"newContent\x18\b \x01(\tR\n" +
	"newContent\x12 \n" +
	"\vauditResult\x18\t \x01(\x05R\vauditResult\x12\"\n" +
	"\frejectReason\x18\n" +
	" \x01(\tR\frejectReason\x12\x1c\n" +
	"\tauditTime\x18\v \x01(\tR\tauditTime\x12\x1c\n" +
	"\tcreatedAt\x18\f \x01(\tR\tcreatedAt2\xac\x04\n" +
