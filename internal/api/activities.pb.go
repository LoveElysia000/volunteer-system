...
type ActivityListRequest struct {
	...
	// 是否只看我已报名的活动 可选 @gotags: json:"registeredOnly"
	RegisteredOnly bool `protobuf:"varint,9,opt,name=registeredOnly,proto3" json:"registeredOnly"`
...
func (x *ActivityListRequest) GetRegisteredOnly() bool {
	if x != nil {
...
type ActivityDetailRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// 活动ID 必填 @gotags: path:"activityId,required"
	ActivityId    int64 `protobuf:"varint,1,opt,name=activityId,proto3" json:"activityId" path:"activityId,required"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_internal_api_activities_proto_rawDesc = "" +
	"\n" +
	"\x1dinternal/api/activities.proto\x12\bactivity\x1a\x1cgoogle/api/annotations.proto\x1a\x17google/api/client.proto\"\x8d\x02\n" +
	...
	"\fgrantedHours\x18\x04 \x01(\x01R\fgrantedHours\"7\n" +
	"\x15ActivityDetailRequest\x12\x1e\n" +
	"\n" +
	"activityId\x18\x01 \x01(\x03R\n" +
	"activityId\"L\n" +
	...
	"\fgrantedHours\x18\x16 \x01(\x01R\fgrantedHours\"\xa9\x02\n" +
	...
	"\x15UpdateActivityRequest\x12\x1e\n" +
	"\n" +
	"activityId\x18\x01 \x01(\x03R\n" +
	"activityId\x12\x14\n" +
	"\x05title\x18\x02 \x01(\tR\x05title\x12 \n" +
	...
	"\amessage\x18\x01 \x01(\tR\amessage\"7\n" +
	"\x15FinishActivityRequest\x12\x1e\n" +
	"\n" +
	"activityId\x18\x01 \x01(\x03R\n" +
	"activityId\"2\n" +
	"\x16FinishActivityResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage\"\xa6\x01\n" +
	"\x1eGenerateAttendanceCodesRequest\x12\x1e\n" +
	"\n" +
	"activityId\x18\x01 \x01(\x03R\n" +
	"activityId\x120\n" +
	...
	"\x10checkOutExpireAt\x18\a \x01(\tR\x10checkOutExpireAt\"|\n" +
	"\x1aResetAttendanceCodeRequest\x12\x1e\n" +
	"\n" +
	"activityId\x18\x01 \x01(\x03R\n" +
	"activityId\x12\x1a\n" +
	...
	"\x17attendanceCodeUpdatedAt\x18\x06 \x01(\tR\x17attendanceCodeUpdatedAt\"C\n" +
	"!GetActivityAttendanceCodesRequest\x12\x1e\n" +
	"\n" +
	"activityId\x18\x01 \x01(\x03R\n" +
	"activityId\"\xca\x02\n" +
	...
	"\x10ActivityCheckOut\x12!.activity.ActivityCheckOutRequest\x1a\".activity.ActivityCheckOutResponse\"#\x82\xd3\xe4\x93\x02\x1d:\x01*\"\x18/api/activities/checkout\x12y\n" +
	"\x0eActivityDetail\x12\x1f.activity.ActivityDetailRequest\x1a .activity.ActivityDetailResponse\"$\x82\xd3\xe4\x93\x02\x1e\x12\x1c/api/activities/{activityId}\x12v\n" +
	"\x0eCreateActivity\x12\x1f.activity.CreateActivityRequest\x1a .activity.CreateActivityResponse\"!\x82\xd3\xe4\x93\x02\x1b:\x01*\"\x16/api/activities/create\x12|\n" +
	"\x0eUpdateActivity\x12\x1f.activity.UpdateActivityRequest\x1a .activity.UpdateActivityResponse\"'\x82\xd3\xe4\x93\x02!:\x01*\x1a\x1c/api/activities/{activityId}\x12y\n" +
	"\x0eDeleteActivity\x12\x1f.activity.DeleteActivityRequest\x1a .activity.DeleteActivityResponse\"$\x82\xd3\xe4\x93\x02\x1e*\x1c/api/activities/{activityId}\x12\x83\x01\n" +
	"\x0eCancelActivity\x12\x1f.activity.CancelActivityRequest\x1a .activity.CancelActivityResponse\".\x82\xd3\xe4\x93\x02(:\x01*\"#/api/activities/{activityId}/cancel\x12\x83\x01\n" +
	"\x0eFinishActivity\x12\x1f.activity.FinishActivityRequest\x1a .activity.FinishActivityResponse\".\x82\xd3\xe4\x93\x02(:\x01*\"#/api/activities/{activityId}/finish\x12\xb1\x01\n" +
	"\x17GenerateAttendanceCodes\x12(.activity.GenerateAttendanceCodesRequest\x1a).activity.GenerateAttendanceCodesResponse\"A\x82\xd3\xe4\x93\x02;:\x01*\"6/api/activities/{activityId}/attendance-codes/generate\x12\xa2\x01\n" +
	"\x13ResetAttendanceCode\x12$.activity.ResetAttendanceCodeRequest\x1a%.activity.ResetAttendanceCodeResponse\">\x82\xd3\xe4\x93\x028:\x01*\"3/api/activities/{activityId}/attendance-codes/reset\x12\xae\x01\n" +
	"\x1aGetActivityAttendanceCodes\x12+.activity.GetActivityAttendanceCodesRequest\x1a,.activity.GetActivityAttendanceCodesResponse\"5\x82\xd3\xe4\x93\x02/\x12-/api/activities/{activityId}/attendance-codes\x12\xaf\x01\n" +
