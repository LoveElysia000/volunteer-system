...
func newNotification(db *gorm.DB, opts ...gen.DOOption) notification {
	...
	_notification.EventType = field.NewString(tableName, "event_type")
	_notification.BizType = field.NewString(tableName, "biz_type")
	_notification.BizID = field.NewInt64(tableName, "biz_id")
	_notification.SourceOrgID = field.NewInt64(tableName, "source_org_id")
...
type notification struct {
	...
	ALL         field.Asterisk
	ID          field.Int64  // 主键ID
	EventType   field.String // 事件类型: activity_created/activity_updated/member_join
	BizType     field.String // 业务类型: activity/membership/organization
	BizID       field.Int64  // 业务ID
	SourceOrgID field.Int64  // 来源组织ID(用于退出组织后归档)
	SenderID    field.Int64  // 发送方账号ID(关联sys_accounts.id)
	DedupeKey   field.String // 事件幂等键
	Title       field.String // 通知标题
	Content     field.String // 通知正文
...
func (n *notification) updateTableName(table string) *notification {
	...
	n.BizType = field.NewString(table, "biz_type")
	n.BizID = field.NewInt64(table, "biz_id")
...
func (n *notification) fillFieldMap() {
	...
	n.fieldMap["biz_type"] = n.BizType
	n.fieldMap["biz_id"] = n.BizID
